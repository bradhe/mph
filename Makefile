...
pkgdatadir = $(datadir)/mph
pkgincludedir = $(includedir)/mph
pkglibdir = $(libdir)/mph
pkglibexecdir = $(libexecdir)/mph
...
top_srcdir = .
SUBDIRS = src 
EXTRA_DIST = mph.spec configure.ac mph.pc.in mph.pc.in LGPL-2 MPL-1.1
